...
#define DELTA_DIAGONAL_ROD 229.25 // mm (215)

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 182 // mm (137.0) 

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 29 // mm (19.9)
...
#define Y_MAX_POS 86
#define Y_MIN_POS -86
#define Z_MAX_POS (MANUAL_Z_HOME_POS+0.5)
#define Z_MIN_POS 0
...
#define MANUAL_Z_HOME_POS 261  // For delta: Distance between nozzle and print surface after homing.
...
#define Z_PROBE_OFFSET {0, 20, -3.3, 0}  // (0, 14, -6.5, 0) X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.(0,19,-8,0)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {82.0976 , 82.0976 , 82.0976 , 100} // X, Y, Z, E
